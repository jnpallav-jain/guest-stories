...
# Create Concierge, our gala agent, with the guest info tool
...
if __name__ == "__main__":
    print("🎩 Concierge is at your service. Type 'exit' to leave the gala.\n")
    ...
    while True:
        ...
        print("🎩 Concierge's Response:")
        print(response)
        print()

        trim_memory(concierge)
